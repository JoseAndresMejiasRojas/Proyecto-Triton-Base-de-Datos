...
( 
	...
	CONSTRAINT CK_ZIP_Code CHECK (ZIP_Code >= 10000 AND ZIP_CODE <= 99999),	-- 5 dígitos.
...
(
	...
	CONSTRAINT FK_Correo_Numero_Entrenamiento FOREIGN KEY(Correo_FK, Numero_Entrenamiento_FK) REFERENCES Bloque_Entrenamiento_A (Correo_FK, Numero_Entrenamiento_FK)	-- Se hizo un FK apuntando únicamente a Bloque_Entrenamiento_A.
